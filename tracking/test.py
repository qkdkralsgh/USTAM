...
def run_tracker(tracker_name, tracker_param, run_id=None, dataset_name='otb', sequence=None, debug=0, viz_attn=0, threads=0,
    ...
    run_dataset(dataset, trackers, debug, viz_attn, threads, num_gpus=num_gpus)
...
def main():
    ...
    parser.add_argument('--viz_attn', type=int, default=0, help='Visualize attention map.')
    ...
    run_tracker(args.tracker_name, args.tracker_param, args.runid, args.dataset_name, seq_name, args.debug, args.viz_attn,
