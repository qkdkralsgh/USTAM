...
##########-------------- MixViT-L -----------------##########
### LaSOT test and evaluation
# python tracking/test.py mixformer_vit baseline_large --dataset lasot --threads 8 --num_gpus 4 --params__model MixViT_L_S/MixFormer_ep0480.pth.tar --params__search_area_scale 4.55 --viz_attn 1
...
### TrackingNet test and pack
python tracking/test.py mixformer_vit baseline_large --dataset trackingnet --threads 8 --num_gpus 4 --params__model MixViT_L_S/MixFormer_ep0480.pth.tar --params__search_area_scale 4.6 --viz_attn 1
# python lib/test/utils/transform_trackingnet.py --tracker_name mixformer_vit --cfg_name baseline

### GOT10k test and pack
#python tracking/test.py mixformer_vit baseline_got --dataset got_10k_test --threads 16 --num_gpus 4 --params__model MixViT_B_S_got10k_new2/MixFormer_ep0475.pth.tar #--viz_attn 1 # --debug 1
#python lib/test/utils/transform_got10k.py --tracker_name mixformer_vit --cfg_name baseline_got
