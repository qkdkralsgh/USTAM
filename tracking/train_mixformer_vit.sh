...
python tracking/train.py --script mixformer_vit --config baseline_got --save_dir output --mode multiple --nproc_per_node 4
...
#python tracking/train.py --script mixformer_vit --config baseline_large --save_dir output --mode multiple --nproc_per_node 4
#python tracking/train.py --script mixformer_vit --config baseline_large --save_dir output --mode single # multiple --nproc_per_node 2 # --stage1_model /STAGE1/MODEL
