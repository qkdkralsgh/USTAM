...
dataset_dict = dict(
    ...
    got_10k_test=DatasetInfo(module=pt % "got_10k", class_name="GOT_10KDataset", kwargs=dict(split='test')),
    got_10k_val=DatasetInfo(module=pt % "got_10k", class_name="GOT_10KDataset", kwargs=dict(split='val')),
    got_10k_ltrval=DatasetInfo(module=pt % "got_10k", class_name="GOT_10KDataset", kwargs=dict(split='ltrval')),
